      ...
      <main className="mx-auto max-w-5xl pb-24">
        <div className="px-5">
          <h1 className="my-4 text-3xl font-semibold lg:text-4xl">
            {items.length > 0 ? "Review your bag" : "Your cart is empty"}
          </h1>
          <p className="my-4">Free delivery and free return.</p>
          {items.length == 0 && (
            <Button
        ...
        {items.length > 0 && (
          <div className="mx-5 md:mx-8">
            ...
            <div className="my-6 mt-2 max-w-5xl">
              ...
              <div className="my-14 space-y-4">
                ...
                <div className="flex flex-col gap-4 md:flex-row">
                  ...
                  items-center rounded-xl bg-gray-200 p-8 py-12 text-center"
                  >
